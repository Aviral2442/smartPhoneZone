    ...
    <div class="sectionHeader shadow p-3">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link active " id="viewBlog-tab" data-bs-toggle="tab" data-bs-target="#viewBlog"
                    type="button" role="tab" aria-controls="viewBlog" aria-selected="true">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link text-gray" id="editBlog-tab" data-bs-toggle="tab" data-bs-target="#editBlog"
                    type="button" role="tab" aria-controls="editBlog" aria-selected="false">
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade show active" id="viewBlog" role="tabpanel" aria-labelledby="viewBlog-tab">
            <div class="container shadow p-4 mt-md-3">
                <h2 class="text-center py-2 font-family"> <span><i class="fa-solid fa-table-list"></i></span> &nbsp; Blog
                    Lists </h2>
                <hr>
                    ...
                    <tbody>
                        ...
                        @foreach ($blogsList as $item)
                            <tr>
                                ...
                                <td>{{ $item->blog_id }}</td>
                                <td><img src="{{ $item->blogFeaturedImg }}" class="rounded" width="150px" height="80px"
                                        alt="{{ $item->blogImgAlt }}"></td>
                                <td>{{ $item->blogTitle }}</td>
                                <td>{{ $item->blogCategory_id }}</td>
                                ...
                                <td>
                                    <a {{-- href="{{ route('admin.editBlog', $item->blog_id) }}"  --}} class="btn btn-primary">Edit</a>
                                    <a {{-- href="{{ route('admin.deleteBlog', $item->blog_id) }}"  --}} class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
                    ...
                    <form action="{{ route('admin.addBlogs') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-flex py-3">
                            ...
                            <div class="col-md-8 d-flex">
                                <input type="file" placeholder="Enter Blog Slug"
                                    class="form-control form-fields p-2 rounded" name="blogFeaturedImg" id="blogFeaturedImg"
                                    required>
                        ...
                        <div class="d-flex py-3">
                            <div class="col-md-3">
                                <label class="p-2 font-family" for="">Blog Image Alt text</label>
                                <span class="feild-required">*</span>
                            </div>
                            <div class="col-md-8">
                                <input type="text" placeholder="Enter Blog Image Alt text"
                                    class="form-fields form-control p-2 rounded" name="blogImgAlt" id="blogImgAlt"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="d-flex py-3">
                            ...
                            <div class="col-md-8">
                                <input type="text" placeholder="Enter Blog Title"
                                    class="form-fields form-control p-2 rounded" name="blogTitle" id="blogTitle"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="d-flex py-3">
                            ...
                            <div class="col-md-8">
                                <input type="text" placeholder="Enter Blog Slug"
                                    class="form-fields form-control p-2 rounded" name="blogSlug" id="blogSlug" required>
                            </div>
                        </div>
                        ...
                        <div class="d-flex py-3">
                            ...
                            <div class="col-md-8">
                                <textarea type="text" placeholder="Enter Blog Description" class="form-control form-fields p-2 rounded"
                                    name="blogDescription" id="blogDescription" required>
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="d-flex py-3">
                            ...
                            <div class="col-md-8">
                                <input type="text" placeholder="Enter Blog Category"
                                    class="form-control form-fields p-2 rounded" name="blogCategory_id"
                        ...
                        <div class="d-flex py-3">
                            ...
                            <div class="col-md-8">
                                <input type="text" placeholder="Enter Blog Tags"
                                    class="form-control form-fields p-2 rounded" name="blogTags" id="blogTags" required>
                            </div>
                        </div>
                        ...
                        <div class="d-flex py-3">
                            ...
                            <div class="col-md-8">
                                <input type="text" placeholder="Enter Blog Keywords"
                                    class="form-control form-fields p-2 rounded" name="blogKeywords" id="blogKeywords"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="d-flex py-3">
                            ...
                            <div class="col-md-8">
                                <input type="text" placeholder="Enter Blog Meta Title"
                                    class="form-control form-fields p-2 rounded" name="blogMetaTitle" id="blogMetaTitle"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="d-flex py-3">
                            ...
                            <div class="col-md-8">
                                <input type="text" placeholder="Enter Blog Meta Description"
                                    class="form-fields form-control p-2 rounded" name="blogMetaDescription"
                                    id="blogMetaDescription" required>
                            </div>
                        </div>
                        ...
                        <div class="d-flex py-3">
                            ...
                            <div class="col-md-8">
                                <input type="text" placeholder="Enter Blog Meta Keywords"
                                    class="form-fields p-2 form-control rounded" name="blogMetaKeywords"
                                    id="blogMetaKeywords" required>
                            </div>
                        </div>
                        ...
                        <div class="d-flex py-3">
                            ...
                            <div class="col-md-8">
                                <select name="blogStatus" id="blogStatus" class="form-control form-fields p-2 rounded"
                                    required>
        ...
        <div class="tab-pane fade" id="editBlog" role="tabpanel" aria-labelledby="editBlog-tab">
            <div class="container shadow p-4 mt-md-3">
                <h2 class="text-center py-2 font-family"> <span><i class="fa-solid fa-dice-d6"></i></span> &nbsp; Edit
                    Blogs </h2>
                <hr>
                <div class="form px-5 pt-4">
                    <form action="{{ route('admin.addBlogs') }}" method="POST" enctype="multipart/form-data">
